const Services = () => {
  return (
    <div className="md:flex py-8 lg:py-16 mt-8 lg:gap-16 ">
      <img src="/src/assets/images/Project Cover.png" className="w-[500px]"/>
      <div>
        <h2 className="text-lg lg:text-3xl 2xl:text-[36px] font-semibold text-[#1F1F1F] text-center md:text-start">About US</h2>
